...
for (i, imagePath) in enumerate(imagePaths):
    ...
    # detect được faces
        ...
        for d in dets:
            ...
            # lấy ảnh box của khuôn mặt, resize về cùng kích thước
