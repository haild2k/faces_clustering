...
file_no_faces = open(r'F:\CT_codes\faces_clustering_done\save_files\files_no_faces.txt', 'r')
...
file_have_faces = open(r'F:\CT_codes\faces_clustering_done\save_files\files_have_faces.txt', 'r')
...
# load shape
file_shape = open(r'F:\CT_codes\faces_clustering_done\save_files\shape.txt', 'r')
encoding_shape = file_shape.read()
file_shape.close
temp = re.findall(r'\d+', encoding_shape)
res = list(map(int, temp))
# print(res)
encoding_faces = np.loadtxt(r"F:\CT_codes\faces_clustering_done\save_files\files_encodings.txt").reshape(tuple(res))
...
# tạo số lượng folder theo số cụm
parent_dir = r"F:\CT_codes\faces_clustering_done\static"
